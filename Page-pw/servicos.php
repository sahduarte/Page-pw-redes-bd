...
<body>
    ...
    <div class="container mt-3">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="GerServico.php?idDel=<?php echo $row->idServico?>" class="btn btn-info" onclick= "return confirm('Deseja excluir o Serviço <?php echo $row->nomeServico; ?> ?')">
        ...
        <a href="GerServico.php" class="btn btn-info btn-lg">
