...
<body>
    ...
    <div class="container mt-3">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="GerCliente.php?idDel=<?php echo $row->idCliente?>" class="btn btn-info" onclick= "return confirm('Deseja excluir o Cliente <?php echo $row->nomeCliente; ?> ?')">
        ...
        <a href="GerCliente.php" class="btn btn-info btn-lg">
