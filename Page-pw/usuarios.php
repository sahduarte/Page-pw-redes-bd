...
<body> 
    ...
    <div class="container mt-3">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="GerUsuario.php?idDel=<?php echo $row->idUsuario?>" class="btn btn-info" onclick= "return confirm('Deseja excluir o Usuário <?php echo $row->loginUsuario; ?> ?')">
        ...
        <a href="GerUsuario.php" class="btn btn-info btn-lg">
